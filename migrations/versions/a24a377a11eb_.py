...
Revision ID: a24a377a11eb
Revises: 
Create Date: 2024-03-07 20:16:02.608848
...
def upgrade():
    ...
    sa.Column('nombre_personaje', sa.String(length=100), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name_Vehicles', sa.String(length=50), nullable=True),
